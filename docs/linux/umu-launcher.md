...
1. Make a new empty folder for a new prefix
1. In lutris: \
   Game Options: Select your game and the new prefix folder you just created \
   Runner Options: Select Proton or Proton-GE
1. A lot of the interface options in Lutris like locale do not work so have to be set in Environment Variables.
1. Run the game to create the prefix. Don't create the prefix with WINEARCH command since it can give errors.
