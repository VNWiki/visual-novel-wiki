...
- Cross Days（クロスデイズ） 初回限定版
  ...
  /HWN-4@41F068 /pnCrossDays.exe (v1.00a)
- SummerDays Ver2: /HA4@2B1A0:rvmm.dll //ver 2.01 (additional tips here - refers to original wiki context)
- School Days: Instructions here (additional tips here - refers to original wiki context)
- School Days HQ: /KF32:16 /HQN30@43B66B
```
...
- 鬼まり。: /HA-10:58@4ABD18 /pnreallive.exe (remove :58 if you want names)
```
...
- STEINS；GATE 0[STEINS GATE 0]
  ...
  Note: 必须下载Hookpatch补丁后再使用特殊码。(Must download Hookpatch patch before using the special code.)
  下载地址: (Download links)
  http://99ib.cc/file-988772.html
  http://filemarkets.com/fs/ew2ade5ccyf2a73/
  原帖: http://www.hongfire.com/forum/forum/hentai-lair/hentai-game-discussion/tools-and-tutorials/15208-agth-text-extraction-tool-for-games-translation?p=5719420#post5719420
```
...
- 妻みぐい3 /HSN-1C:-14@200E25HSN-8@46F7CF (V1.02し)
...
- アリス2010: /HBN1C*4@0:StoatSpriteEngine.dll:SP_SetTextSprite /Ftext@1
- ばにしゅ！～おっぱいの消えた王国～: /HB8*4@59370:StoatSpriteEngine.dll (use /pn)
- ALICEの館7: /HB-4*0@9CA0:SactEngine.dll /pnSYSTEM40.exe
- 超昂閃忍ハルカ: /HBN8C@EE78:SactEngineDX.dll /PNSYSTEM40.exe (see this post for more detail). Can also try /HB30*0@13DC0:SactEngineDX.dll /pnSYSTEM40.exe or /HB40*0@13DC0:SactEngineDX.dll /pnSYSTEM40.exe
- だぶる先生らいふっ: /HBN8C@DC7D:SactEngineDX.dll /pnSystem40.exe or /HB-4*0@B0F0:SACTDX.dll /pnSystem40.exe (see this post for more detail). Can also try /HB30*0@12760:SactEngineDX.dll /pnSYSTEM40.exe or /HB40*0@12760:SactEngineDX.dll /pnSYSTEM40.exe
- GALZOOアイランド: /HB1C*0@A830:SactEngine.dll /pnSYSTEM40.exe
- 魔女の贖罪: /HB28*0@AF40:SactEngine.dll /pnSYSTEM40.exe
- お嬢様をいいなりにするゲーム: /HB28@13F70:SactEngineDX.dll /pnSYSTEM40.exe or /HB-C*0@13F70:SactEngineDX.dll /pnSYSTEM40.exe or /HB30*0@135F0:SactEngineDX.dll /pnSYSTEM40.exe or /HB40*0@135F0:SactEngineDX.dll /pnSYSTEM40.exe
- ぱすてるチャイムContinue: /HB1C*0@03E1A810 or /HB1C*0@A810:SactEngine.dll /pnSYSTEM40.exe
- ぱすちゃC＋＋: /HB1C*0@03E0A830 or /HB1C*0@A830:SactEngine.dll /pnSYSTEM40.exe
- 妻しぼり: /HB40*0@3DDAED0 or /HB40*0@AED0:SactEngine.dll /pnSYSTEM40.exe
- よくばりサボテン: /HB40*0@AED0:SactEngine.dll /pnSYSTEM40.exe
```
...
- MapleColors2: /HA8@5472F0 /KF (v1.01)
  /HAN8@546DA0 /KF
...
- 夢みる月のルナルティア
  ...
  ITH CODE：/HBN-C*0:-14@42D54D or /HBN-C*0:4C@42D54D
```
...
- 最終痴漢電車 DVD EDITION: /HB28@434467C
- 最終痴漢電車２: /HB28@432C9C
- 瀬里奈: /HB28@43E2AC
...
- 夜明け前より瑠璃色な -Moonlight Cradle- / 夜明け前より瑠璃色な－Brighter than dawning blue－ for PC
  /HAC@421920
  /HA8@414040 or /HA68@4057F0
  /HSC@44782A
- 千の刃濤、桃花染の皇姫 体験版 /HS8:20@35640:BGI.exe
- 千の刃濤、桃花染の皇姫 プレミアムパック[Sen no Hatou, Tsukisome no Kouki]
...
- あねいも×あねいも２　サマー愛ランド　～二組のカップル　皐月＆真奈美編～
  /HBC@455D80
- ふたあねHs ～若葉とあやめのLOVEエロ物語～：/HBC@4A7580
...
- Triangle Love -アプリコットフィズ-[Triangle Love -Apricot Fizz-]
  ...
  Note: 虽然已经自动输入了特殊码，但是发现读取到一定文本后就不会读取到新的文本了，必须要重启游戏才能再读取。 解决这个问题的话可以用这个公司的老办法，修改字体设置。打开游戏目录的malie.ini。然后
  将
  ;FONT01=MS UI Gothic
  FONT01=MS UI Gothic
  ;FONT01=MS UI Gothic
  ...
  ("Although the special code has been automatically entered, it was found that after reading a certain amount of text, no new text will be read, and the game must be restarted to read again. To solve this problem, you can use the old method of this company, modify the font settings. Open malie.ini in the game directory. Then change the FONT01 settings as shown. The regret of this old method is that, as before, the text cannot be displayed in the game, but VNR can read the text normally.")
- ナツウソ-Ahead of the reminiscence-
  /hwn-4@65905E
  /hwn-4:-C@65905E
  Note: 2选1。下面一个带有过滤，也就是注音日文和原文分开，当然字体大小颜色变一下的文字也会独立出来，如果不在乎注意，就选第一个。 ("Choose 1 of 2. The one below has filtering, meaning furigana and original text are separated, and text with different font sizes/colors will also be independent. If you don't care about the furigana, choose the first one.")
  Delete System folder in game folder.【在游戏文件夹,删除“System”文件夹。】可VNR提取文本 ("Delete the 'System' folder in the game folder. VNR can extract text.")
- 不運と幸運と恋占いのタロット
...
- メカミミ： /HB-8*@42AFA7 （Version: 1.0.0.0）| /HB-8*@42AF97 （Version: 1.1.0.0）
- 白衣の天使はお世話好き！ ～ラブラブエッチな入院生活～
  特殊码:/HSN@467CCE (Note: Chinese text: "Special code:")
...
- 処女はお姉さまに恋してる　2人のエルダー: /HSN8@415CF0 (v1.1)
...
- 妹スマイル Imouto Smile
  ...
  /Fdialogue@4325F5:1;choices@4328C3:0 (Additional options for the above code)
```
...
- 続・ママクラブ: (updzmc01) /HB-1C*0@40B270
```
...
- 甘夏アドゥレセンス
  ver 1.1
  /HWN14*0@53519C
  Note: 如果修正补丁走安装安装程序装不完，还要手动把data文件夹里的乱码启动程序文件改名后替换掉原启动程序才行 (If the correction patch cannot be fully installed through the installer, you also need to manually rename the garbled startup program file in the data folder and replace the original startup program.)
  打v1.1补丁，改名，覆盖原exe程序 (Apply v1.1 patch, rename, overwrite original exe program)
```
...
- MONSTER PARK～化け物に魅入られし姫～: /HS4@41E9B0 (DL) | /HS4@41EA00 v1.1 (DL)
```
...
- キュートリゾート ～しようよ♥エッチなアクティビティ～
  /HS8@5D998:pix.exe
- ちんくる★ツインクル フェスティバル！ -Tincle★Twinkle Festival！
  ちんくる★ツインクル フェスティバル！v1.21
  /HS-20:-4@21FE97:Taskforce2.exe
  Note: Own made has some extra threads but working thread for name and text.
  必须更新到1.21版本才能使用 (Must update to version 1.21 to use.)
  1.21补丁下载: http://www.digitalcute.com/main/support/softwareupdates/ttf_update/%E3%83%80%E3%82%A6%E3%83%B3%E3%83%AD%E3%83%BC%E3%83%89.html
  @aoyu18原帖:[http://www.hongfire.com/forum/forum/hentai-lair/hentai-game-discussion/tools-and-tutorials/15208-agth-text-extraction-tool-for-games-translation/page516]
```
...
- オタカノ－こんなに可愛い彼女がオタクなわけがない
  /HBC*0@4044f0 /kf
  /HB-4@4042B2 /ks4 /kf4 (Alternative entry)
- ぷりサガ！～ボクの妃は×××～ : /HBC*0@4044B0 /KF
- メイでぃ！～ご主人様は同級生～: /HBC*0@404500 /KF
- ぷりサガ！Ｘ: /HSC@4044C0 /KF
- 彷徨う魂に安らぎの刻を : /HB4@404270 /KF or /HSC@4044D0 /KF
...
- お嬢様はイイナリみたいです！？
  ...
  对话 /HS-4@32C51:ags.exe (Dialogue)
```
...
- 英雄伝説 空の軌跡SC: (SR2_1020) /HB4*0@4C29A0 /KF32:16 or /HB-20*0@4C29A0 /KF32:16
- 英雄伝説 空の軌跡the3rd: (SR3_1001) /HB4*0@49C140 /KF32:16 or /HB-20*0@49C140 /KF32:16 | (SR3_1002) /HB4*0@49C0C0 /KF32:16 or /HB-20*0@49C0C0 /KF32:16
...
- Frill Extreme Collection -痴漢専用車両アートワークス＆ファンディスク-: /HA4@47DCB7
- ボイン姉妹の個人授業: /HA-20@40ED20 or /HA4@40ED20
- 痴漢専用車両2: /HAN-C:-14@445478 (use /pn)
...
- 魔界天使ジブリール  -episode 2-: /HSN0:C@405484 | Vista Version: /HBN-C*1@4D2276
- 魔界天使ジブリール Vista对应版: /HSN-C:-8@50F623
- 魔界天使ジブリール -episode 3-: /HSN-C:-8@509091
- めがちゅ！: /HAC@47E762
- 私立アキハバラ学園 (Ver. 1.01): /HB18*0@44011C
- そらうた: /HA14@422FCC | Vista对应版: /HBN-C*1@4DDF45
...
- Queenボンジョルの！～女王は制服を脱いだ～: /HAN4:-4@4094AE
...
- 異世界に召喚された俺は寝取られスキル持ちだった！？
  ...
  /HW-8:1C*0@15EB:mono.dll ←推荐 (Recommended)
  Note: 将VNR目录下Visual Novel Reader\Library\Frameworks\Sakura\py\libs\gameengine，把gameengine这个目录改名，改成gameengine1之类的都行，再使用特殊码
  (Rename the gameengine directory in VNR\Library\Frameworks\Sakura\py\libs\gameengine to something like gameengine1, then use the special code.)
  提问:改名会对其他游戏或者其他特殊码有别的影响吗？
  (Question: Will renaming affect other games or other special codes?)
  回答:有影响，那个目录下有个engine.py是手动编写附加的特殊码，但是会有冲突，mono，nitroplus，system4这几个引擎有影响，文件夹名改回来重启vnr就行
  (Answer: Yes, it will have an impact. There is an engine.py in that directory which is a manually written additional special code, but there will be conflicts. Mono, Nitroplus, System4 engines are affected. Rename the folder back and restart VNR to fix it.)
```
...
- 出撃!!乙女たちの戦場～闇を切り裂く、にび色の徹甲弾～ /HBN-4*0@4FD1B5 (1.02)
  v1.02, cracked exe：/HBN-4*0@4FD1B5
```
...
- BALDR FORCE EXE: /HB-8*0@49DDCD | (With Hell Mode Add-on): /HB-8*0@49DDBD | /HSN18@4637F6 (v1.10)
- Baldr Sky: /x /v /fDiaglogue@61A65F /pnbaldrsky.exe (v1.02) | /HB10*0@5E244B (v1.01) | /c /x /v /fDiaglogue@619CAF /pnbaldrsky.exe (v.1.01) | /c /x /v /fDiaglogue@6183EF /pnbaldrsky.exe
...
- グリーングリーン3　ハローグッバイ: (use GG3_update101) /HB4*0@415AA0 or /HA1C@415AA0
- 鐘ノ音ダイナティック: (use dynatic_update101) /HB4*0@415AA0 or /HA1C@415AA0
```
...
- Ran→Sem ~Hakudaku Delmo Tsuma no Miira Tori~
  ...
  Note: Message speed needs to be set to something slower then fastest(instant) or text wont show up in agth. As with earlier guilty titles /HB8*0:44@0:GDI32.dll:GetTextExtentPoint32A works with this game. The /F part below varies from game to game (leave it out, if you try it with a different game), but helps to remove all useless threads.
- 馴染みのオバちゃん～バツイチ熟女と淫乱未亡人～
  /HB8*0:2C@0:GDI32.dll:GetTextExtentPoint32A
- 痴漢サークル: /HB8*0:28@0:GDI32.dll:GetTextExtentPoint32A /Fchoices@42FE3E:ffffff;text@42FE3E
- 痴漢サークル2: /HB8*0:44@0:GDI32.dll:GetTextExtentPoint32A /Ftext@433A52:0;choices@433A52:ffffff
- 痴漢サークル3～人妻ダイヤグラム・完結篇～: /HB8*0:44@0:GDI32.dll:GetTextExtentPoint32A /Ftext@433AE2:0;choices@433AE2:ffffff
- RIN×SEN～白濁女教師と野郎～:  /HB8*0:44@0:GDI32.dll:GetTextExtentPoint32A /Ftext@4339A2:0;choices@4339A2:ffffff
- Last Waltz ～白濁まみれの夏合宿～: /HB8*0:44@0:GDI32.dll:GetTextExtentPoint32A /Ftext@4339A2:0;choices@4339A2:ffffff
  Note: For Guilty+ titles, message speed needs to be set to something slower than fastest(instant) or text won't show up in AGTH.
```
...
- つま恋。
  /HA8*0@45AC40
- ANI嫁だからっ！: /HAN24@46EAC5 /pnaniyome.exe | (Ver. 1.01) /HAN-4@46E321
...
- おかあさんとな・い・しょ～美人母娘、別荘監禁7日間～: (ver1.00) /HB10*0@410B49 | (ver1.01)/HB10*0@410C0B
...
- とらいあんぐるハート DVD Edition (use thd20020623.exe patch from official site):
  Triangle Hearts = /HB+4*0@41D730
  Triangle Hearts 2 = /HB+4*0@41DB90
  Triangle Hearts 3 = /HB+4*0@41D6E0
  Love Love Toy Box = /HB+4*0@41DD10
  Lyrical Toy Box = /HB+4*0@420AC0
  Toraha DVD Omake Scenerio = /HB+4*0@41C850
```
...
- 姦交バスツアー～色情に染められた花嫁～
  /HA4@41A2F8
- 家族監禁 ～愛妻さやか、奈落の底の快楽人形～: /HA-C@41A190
```
...
- 女教師を喰らう: /x3 /HB4*0@4839A7 /Fdialogue@43F8CF;all(choices,junk)@4839BE /W43F8CF
  /HBC*0@4044C0 /KF (Alternative code)
...
- WHITE ALBUM 2～introductory chapter + closing chapter～ SET版
  /HS0@438604 (ver 1.01)
- White Album 2
  /HS0@4383F4 (closing chapter)
- 星の王子くん: /HSN-4@42F2C0
- 君が呼ぶ、メギドの丘で: /HS-8:8@5D001B or /HBN-8*0@4FC681 or /HS4@5CDEDE (v1.01)
- 痕－きずあと－ (Re-release): Use loader located here (freeze work-around here - refers to original wiki context)
  /HBN-4@4AFCEA /KF
- 鎖－くさり－DVD: /HB4*0@4179D0 (Must patch with this NoDVD patch first)
- 愛佳でいくの!!～Leaf Amusement Soft Vol.5～: Dragon Chronicle Guilty Requiem: /HWN-8@40138F or /HWN-8@100138F | Mananatsu: /HSN-1C@410217
- Routes: (DVD) /HB14@47CA20 /kf | (CD) /HS1C@476999 /KF
- 雫－しずく－ DVD: /HB14@47D460 /kf | (Re-release w/ Kizuato): Use loader located here (refers to original wiki)
  /HBN-C@4B2BAD /KF
- 誰彼～たそがれ～: /HB30@485440 /KF
- Tears to Tiara: /HSN1C@410EBD /KF
- ToHeart2 X-Rated: Use this loader and instructions found here (refers to original wiki)
- ToHeart2 Another Days: Use this loader or follow the instructions found here | (Ver. 1.02) /HSC@38286:AnotherDays.dll (use /pn) (refers to original wiki)
```
...
- タペストリー -you will meet yourself-
  ...
  /HWN-4:-8@C4F8:tools.dll /KF /FDialogue@1:3;Choices (BreakKeytoHalt)@1:1 (use /pn)
- まじのコンプレックス
...
- どんちゃんがきゅ～: /HWN-4:-8@E168:tools.dll /KF /FDialogue@1:3;Choices(BreakKeytoHalt)@1:1 (use /pn)
  ...
  Note: requires /pn for alternatives
- 紅（くれない）: /HA8@40BC30
...
- 昇龍戦姫 天夢: /HAN-4@413FA0 /KS /KF /Ftext@1 (use /pnsfa12.exe)
...
- ☀ Dearest Blue [DearestBlue]
  ...
  Note: 把体验版目录下的DearestBlue_web体験版01.exe复制到正式版Dearest Blue目录下,然后用VNR打开DearestBlue_web体験版01.exe，用特殊码/HB8*0@E7E0:DearestBlue_web 体験版01.exe就能解决。 (Copy DearestBlue_web体験版01.exe from the trial version directory to the full Dearest Blue directory, then open DearestBlue_web体験版01.exe with VNR, and use the special code /HB8*0@E7E0:DearestBlue_web 体験版01.exe to solve it.)
...
- ティンクル☆くるせいだーす -SBX-：/HBC@48F3F0
  Note: it require ver 1.01 patch & set font in option 'MSゴシック'
- ティンクル☆くるせいだーす: (Ver. 1.30) /HBN-C@464123 (kurukuru.exe 60FPS version) or /HBN-C@463033 (kurukuru30.exe 30FPS version) | プレミアムエディション: /HBN-C@463CE3
  /HBN-4@463D76
  /HSN2C@463D65
```
...
- タユタマ -kiss on my deity-: /HAC@420680 | DISC1: /HS8:20@398F0:Tayutama.exe
- タユタマ -It's Happy Days-: /HAC:-14@405F50 | DISC2: /HS8:20@3A040:TayutamaHD.exe
- タユタマ2 -After Stories
...
- 淫夢学園「だめ…こんなになっちゃうのは夢の中だけなの…！」 : /HA-C@418EE8 or /HABC@440D36 or /HANC@440D36
...
- 夏菓子～なつかし～
  ...
  good hook. (Attached .exe refers to a potential file linked on the original wiki).
...
- Sister Scheme2
  /HB-C*0@40706F
- 破談屋
  /HBN-4*0@42AF06 /PNhadan.exe | /HBN-4*0@42AF96 /PNhadan.exe (hadan_update_001.exe)
  /HB-20*0@420756 /W0012FEA8 /PNhadan.exe
...
- 満淫車両～制服生出しイキ放題～
  /HBC*0@4044F0 /kf
- 熟恋願望 秘めた想いと淫らな愛のカタチ: /HBC*0@4044F0 /KF or /HB4:-14@404290 /KF (use /pn)
- NACHTMUSIK ～穢れし姫に淫獄の旋律を捧ぐ～: /HB4:-14@404290 /KF (use /pnnachtmusik.exe)
  Note: Also, please turn the message speed to max.
- スウィーテスト ママン！: /HBC*0@4044F0 /kf or /HB4:-14@404290 /KF (use /pnswtmaman.exe)
...
- Soul Link: /HA-8@40B8B0 or /HA-8@407370 /KS2 or /HA4@407370 /KS2
...
- Scarlett: (scarlett_fix0523) /HB10*0@411ADB | (scarlett_fix0720v) /HB10*0@411AEB
```
...
- CHAOS;HEAD: /HAN4@403680 or /HAN-C@45A576 (use /pn)
- スマガ: /HAN4@4036D0 or /HAN-C@47E15A (use /pn)
- スマガスペシャル: /HA-4@441AA0 or /HA-4@487190
- 続・殺戮のジャンゴ - 地獄の賞金首: /HA-C@451DD4 or /HA-4@403230
...
- ビッチ学園が清純なはずがないっ！！？
  /HS18*50:18*14@0:GDI32.dll:GetTextMetricsA
```
...
- 母乳が染み出る愛娘 愛美 /HBN-1C*0@415e47 (v1.1)
...
- エーデルワイス: (use edelweiss_update105) /HB4*0@412C80 or /HA1C@412C80
...
- PRISM ARK ~PRISM HEART II~: (ver. 1.00) /HBC@479600 | (ver. 1.01) /HBC@479ca0 | (ver. 1.02b) /HBC@479ce0 | (ver. 1.02c) /HBC@479D10
...
- もしも明日が晴れならば
  ...
  /HSNC@E164A:Graphics.dll /KF1:200 | /hsn-4@0134ADE6 | /HSNC@038E164A /KF1:200 (use /pn)
- MERI+DIA～マリアディアナ～
  /HS-1C@402458 /fText@00000048:00000000 /kf
- えむぴぃ~Maid Promotion Master~: /HA-4@03976E1E /KF or /HA-4@6E1E:Graphics.dll: /KF (use /pn)
...
- まじかる☆ている
  /HSN10@414E6A
  /HSN10@243B2:mTale.exe (Alternative code with note)
...
- 仏蘭西少女 ～Une fille blanche～
  ...
  Note: or use (this patch - refers to original wiki context)
```
...
- 姫様限定！～Princess Limited～
  /HB-C*0@44F094
  Note: (for version) ITH only code, won't work with agth
- 姫恋*シュクレーヌ!(姫戀＊シュクレーヌ)：
...
- さくらいろ、舞うころに /HQN-1C@9434:AdvHD.exe or /HQN-1C@92F0:AdvHD.exe (test required for those two)
...
- 傷モノの学園3－heaven’s door－: /HA-C@418798 or /HB-C@43F968
...
- JK交姦～そこのアナタ、娘の処女を貰ってください～：/HBC*0@4044f0 /kf /pn
...
- ヴァニタスの羊
  /HSN-4@41F4F9
- airy[F]airy ~Easter of Sant' Ariccia~: /HSN-1C:4C@4150AA /KF1:200 or use this .exe (Note: ".exe" refers to original wiki)
- Volume7: /HSN-1C:-4@414947 /KF1:200 /KS /FDiag@1:210;Choice@1:240 or use this .exe (Note: ".exe" refers to original wiki)
```
...
- 校内えっち コスプレ会長 輪姦クラブ: /HAN4@419004 /Ftext@1 (use /pn)
- 校内えっち 妹孕ませ特別授業: /HA4@418F54 or /HB-C*0@43CFC0
- 乱母～未亡人母の熟れた肉体～: /HA4@418F54 or /HBN-C*0@419478 | /HA#1@419154 (Alternative code)
- 教え子の誘惑～家庭教師淫猥レッスン～: /HBN-C*0@419478
- おしかけ御奉仕！～僕のHなメイドさん～: /HA4@418F54
- Tsumugurui: /HA4@418F54
- お姉ちゃんメイドのご奉仕タイム～秘密なんだからね～：/HA-C@41a10c /pnOneechanMaid~.exe
- らぶいも ～お兄ちゃんエッチしよ～：/HA-C@41a10c /pnRT_LOVEIMO.EXE
```
...
- フローラル・フローラブ
  VNR+ITH
  /HW-4@136B2C
- ナツユメナギサ: /HAN-C:-14@4458F8 /PNREALLIVE.EXE
...
- 太陽のプロミア Flowering Days：/HBC@46AA70
```
...
- オト☆プリ～恋せよ！乙女王子様♪ドキドキウェディングベル～: /HSC@4044F0 /KF (use /pnotpr.exe)
...
- 妻ようじ～ボクは人妻管理人～: /HB1C*0@40F1F0 or /HB-8*0@40F2C8 | (with tyouji_update.exe) /HA4@454E28
```
...
- 風紀委員長 聖薇
  Note: Edit AI6WIN.ini file in game folder, Under [font] change "Type = 1" to "Type = 0" That should disable caching and there will be a thread with full text.
...
- Bunny Black (BUNNYBLACK)
  ...
  /HW+C@289860 /PNBunny.exe (v1.1)
- BUNNYBLACK 2 version 1.01：/hq40@b4ae:pgsvtd.dll
- DAISOUNAN: /HA-8@18460:Ags.dll or /HB-1C*0@18460:Ags.dll or /HA-8@18390:Ags.dll or /HB-1C*0@18390:Ags.dll or /HB8*0@18390:Ags.dll
- グリンスヴァールの森の中～成長する学園～: /HA-C@1001BC63 or /HA-C#1@1001BDF5
- 王賊: /HB-20*0@1001755F or /HA-8@16A20:ags.dll or /HA-1C*0@16A20:ags.dll
- 忍流: /HA4@11E70:ags.dll
...
- 恋と選挙とチョコレート
  ...
  Note: （但楼下有人反映打了补丁后使用不能，请勿使用升级补丁）(but someone downstairs reported it cannot be used after patching, please do not use the upgrade patch)
- 蒼の彼方のフォーリズムEXTRA1 (Ao no Kanata no Four Rhythm EXTRA1)
  /HAN4@3CC90:蒼の彼方のフォーリズムEXTRA1.exe
  Note: _配合ISO版本使用，DL版不行 (Use with ISO version, DL version does not work)
```
...
- とらぶるDAYS: Add /x /w434963 parameters or /x /w43496A parameters.
...
- 恋色空模様 初回版
  /HSN8@4D3AC0 (no furigana)
  /HA-4@6F7E20 /KS
  /HAN10:6C@6F7A30 /KS /w1
- 夏彩恋唄
  体验版:/HW4@25BA70:natsukoi_main.exe (Trial version)
  正式版:/HW4@16A2D0:natsukoi_main.exe (Full version)
  VNR(ITH engine) finding method+ change encoding
  /HW4@25BA70:natsukoi_trial.exe (Dialog/ruby)
  /HW4@16A2D0:natsukoi_trial.exe
- 片恋いの月: /HA-4@547D90
- 片恋いの月えくすとら: /HA-4@5C1C40 /KS
- マジカライド: /HA-4@6F62B0
- 巫女さんファイター！涼子ちゃん: /HA4@41F8E0
```
...
- ゴニン!? ～ピタリと的中！強制占い♪～: /HA-18*0@41F810
```
...
- 冒険者の町を作ろう!
  ...
  /HAN-18@485849 /KF (Alternative - Note: Can't say for sure what strings it will catch, I tested only in intro ADV part. Set text speed to instant - 3rd option from above, set it to rightmost of four available values.)
- 人妻スワッピングゲーム: /HANC@43CB40 /KF
...
- スクールぱにっく！
  /HSN38@404E7B
- カタハネ: /HB10*0@411E2B (v1.10) or /HB-18*0@40FD90 (v1.10)
...
- エグゼクタースクリプト: /HSN4@435F40 /PNEXS.EXE
- 魔動装兵クラインハーゼ: /HS+4@0041D950
- 妄想ぷろとこる！：/HSN4@422BC0 /PNdlp.exe
- 少交女[Shoukoujo]
  /HSN-8:3C@125EFD:shoukoujohd.exe
```
...
- お母さんがいっぱい!!
  /HBN10*0@401526 (1.07)
  /KS /HBN10*0@401796 (v1.00)
  /KS /HBN10*0@401476 (v1.01 & v1.03)
- Okaa-san ga Ippai
  /KS /HBN10*0@4015A6 (v1.06)
- お母さんは俺専用！～あなたの初めてを…母さんが貰ってア・ゲ・ル～: /HSN-4@43F3DA
```
...
- KISS×400 懐かしき日々の連続: /HS-C@4848FAB9 or /HS28@48FAB9
...
- 純情化憐フリークス！: /HS4@151200:Freaks.exe
```
...
- 最果てのイマ COMPLETE
  /HSN-10:-C@A30FF:Farthest2015.exe
```
...
- 天神乱漫 LUCKY or UNLUCKY！？
  /HW-4*0@5D331E
- 千恋＊万花: /HQ:20@BDA4:textrender.dll or /HQ@BDA4:textrender.dll
```
...
- fortissimo//Akkord：Bsusvie
  /HSN-320@420050
- 邪!! ぱんでみっく
  /HA-10:48@4ABBB8 or /HAN-C:-14@448878
- ラブ・バインド 初回限定版
  /HAN-C:-14@448278
- Soul Link Ultimate
...
- 主に交われば朱くなる
  /X /W45BE4B
- ABANDONER -THE SEVERED DREAMS- /HSN-1C@0043BBC1
...
- タンテイセブン
  ...
  Note: 崩溃问题请关闭共享辞书。 (For crash issues, please close the shared dictionary.)
- ちっちゃな花嫁 ～まだまだつぼみだもんっ～
  /HS8@4F30:GDI32.dll /HS8@[YOUR ADDRESS]:GDI32.dll
  Note: Hook have not same adress on all os. You need to "file > attach" the game exe in x32dbg then select tab "symbols" select module "gdi32.dll" search in the right search box for "GetTextExtentPoint32A" and use last 4 (7300"4F30") from the full adress. Use TA to delete phrase repeat.
...
- コープスパーティー ブラッドカバー
  ...
  Note: after selecting the correct hook that shows the onscreen text, minimize agth if the game slows down
- bruns.exe
  ...
  Note: As with other bruns.exe games /HW4@0:msvcp80.dll:?push_back@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QAEXG@Z works (if they have msvcp80.dll otherwise replace that by mscvp90.dll)
- 姫騎士壊妊～子宮征服計画～
...
- 癒されご奉仕～夢の館で賢者タイム!～
  ...
  Note: If it doesn't show a proper hook try to remove the /F part and look through the usercode hooks if anybody has it, this is for the version seeded there (I guess 1.00) any update might break the code.
- 淫妖蟲 悦 ～快楽変化退魔録～
  /HBNC*0@4697D0
- スマガスペシャル
  /ha-4@441aa0
...
- Twinkle Crusaders Kurukuru Miracle
  /HBN-C@463CE3
- Twinkle Crusaders (v1.30)
  60FPS version: /HBN-C@464123
  30FPS version: /HBN-C@463033
- Memories off Duet
  /HB8*0@3ADC0:MEM12.exe
- Memories off Sorekara
  /HBN-1C*0@41D74F
- Dungeon Crusaderz 2
  patch 1003: /HB28@4103E8 | patch 1002: /HB28@4103B8
- da capo II p.c.
...
- 愛奴変態調教倶楽部
  ...
  Note: Set Textoutput speed to less then max, or you'll have names and dialogue in one thread - which messes up the translation. If you skip through that happens as well. Doesn't get text of choices.
- 校内えっち コスプレ会長 輪姦クラブ
...
- 美脚性奴会長亜衣
  /HBN-1C*0@415d89
  Note: (Doesn't Show name) Work in text speed slow - normal
...
- 空のつくりかた -under the same sky, over the rainbow- TRIAL　VERSION　ver3.0
  Note: Trial 3.0 have different pattern. umm...
...
- タンテイセブン
  ...
  /HS-4:-8@F6572:pixel.windows.exe
  Note: 崩溃问题请关闭共享辞书。(For crash issues, please close the shared dictionary.)
- 蒼の彼方のフォーリズムEXTRA1: /HAN4@3CC90:蒼の彼方のフォーリズムEXTRA1.exe
  Note: _配合ISO版本使用，DL版不行 (Use with ISO version, DL version does not work)
- 春音アリス＊グラム
  Note: 使用新修正补丁 (Use new correction patch)
- 冒険者の町を作ろう!
  /HAN-18@485849 /KF
  Note: Can't say for sure what strings it will catch, I tested only in intro ADV part. Set text speed to instant - 3rd option from above, set it to rightmost of four available values.
...
- I女の聖域-
  ...
  -Speaker's name and dialogue are split up. For some reason, the speaker's name thread isn't picking up the actual name, but some random words.
...
- バルドスカイ ゼロ[BALDR SKY ZERO][BALDRSKY ZERO]
  Note: 前提:本人亲测Win7x32位,只要将从游戏设置内将【文字表示】游戏显示速度调到文【速い】,VNR就能提取文本翻译 (Prerequisite: I personally tested on Win7 32-bit. As long as you set the [Text Display] game display speed to [Fast] in the game settings, VNR can extract the text for translation.)
  ITH:/HQN4@7620DF0 or /HQN4@7620DF9
  地址:http://bbs.2dkf.com/read.php?tid=411756 @ok123 找特殊码 23楼 (Address: ... @ok123 find special code 23rd floor)
- nekopara_vol0: /HQ:20@A604:textrender.dll or /HQ@A604:textrender.dll
- nekopara_vol1: /HQ:20@9C64:textrender.dll or /HQ@9C64:textrender.dll
- nekopara_vol2: /HQ:20@A704:textrender.dll or /HQ@A704:textrender.dll
- KARAKARA / カラカラ (@calme 2016/06/27): /HQ:20@BD54:textrender.dll or /HQ@BD54:textrender.dll
- Corona Blossom Vol.1 コロナ・ブロッサム: /HQ:20@BDA4:textrender.dll or /HQ@BDA4:textrender.dll
- タユタマ2-you’re the only one- [游魂2 youre my only one]:
  /HS8:20@3A660:Tayutama2.exe
